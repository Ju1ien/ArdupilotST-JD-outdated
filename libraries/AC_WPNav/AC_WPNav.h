...
#define STICK_RELEASE_SMOOTH_ANGLE      1500          // ST-JD : set it from 500 to 1500, means the max number of centideg required to apply to smooth stick release effect (this avoid overshoot)
